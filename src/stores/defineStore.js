...
export const useDefineStore = defineStore('define', {
  state: () => ({
    basemaps: [
      ...
      { label: 'Esri World Imagery', value: 'esri_imagery' },
      ...
      { label: 'Carto Light', value: 'carto_light_labels' },
      { label: 'Carto Dark', value: 'carto_dark_labels' },
      { label: 'Carto Voyager', value: 'carto_voyager' },
