    ...
    <div class="card h-100">
      ...
      <div class="card-body">
        ...
        <div class="mb-3">
          ...
          />
          <div class="form-text">支援 TWD97 和 WGS84 座標系統，系統會自動檢測並轉換</div>
        </div>
        ...
        <div v-if="geometryTypes.length > 0" class="mb-3">
          ...
          <div class="row g-2">
            <div v-for="type in geometryTypes" :key="type.name" class="col-12">
        ...
        <div v-if="geoData" class="d-grid gap-2">
          ...
          <button class="btn btn-primary btn-icon" @click="addToMap">
            <i class="fas fa-map"></i>
            <span>加入地圖</span>
          </button>

          <!-- 📈 空間分析按鈕 (Spatial Analysis Button) -->
          <button class="btn btn-outline-secondary btn-icon" @click="analyzeData">
            <i class="fas fa-chart-line"></i>
            <span>空間分析</span>
          </button>

          <!-- 🗑️ 清除資料按鈕 (Clear Data Button) -->
          <button class="btn btn-outline-danger btn-icon" @click="clearData">
